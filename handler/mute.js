...
module.exports.run = async (client, message, args) => {
	...
	if (member.id == message.member.id) return message.reply('эй! Не надо мутить себя');
